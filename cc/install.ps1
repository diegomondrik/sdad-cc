# SDAD-CC v3.1 - Installer for Windows (PowerShell)
...
function Show-Header {
    Write-Host ""
    Write-Host "SDAD-CC v3.1 - Installer" -ForegroundColor Cyan
...
# Verify we are inside a project folder, not the user home
...
if ($currentPath -eq $homePath) {
    ...
    Write-Host "  Run the installer from inside your project folder instead:" -ForegroundColor Red
...
Show-Step "Downloading SDAD-CC v3.1 files..."
...
# DONE
Write-Host ""
Write-Host "SDAD-CC v3.1 installed successfully!" -ForegroundColor Green
Write-Host ""
...
Write-Host "     Download project-init.ps1 and run from inside your project folder:"
